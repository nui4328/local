...
void start_run()
  {
        ...
        if(analogRead(28) <= 1500) 
          {
            ...
            fw_a3_a4(50, 50, 0.3, 0);
            do{Motor(40, 40);}while(mcp_b(1) > md_mcp_b(1));
            delay(50);
            st_can1 = 1;
   ...
   ///////////////////////////////////////////////////////////////////////////เริ่มกล้อง 222222222222222
    ...
    ////////////////////////#########################////////////////////###############  can2
        ...
        if(analogRead(28) <= 1500) 
            {
              bline(30,30, 0.3, 200, 'n', 's',50, "a2", 1); 
    ...
    if(analogRead(28) <= 1500) 
      {
        ...
        bline(40,40,0.4,300,'n','r',50, "a4", 30);
        fline(50,50,0.2,0,'c','p',80, "a4", 30);
        ...
        if(analogRead(28) <= 1500) 
          {
            ...
            fw_a3_a4(50, 50, 0.3, 0);
            do{Motor(40, 40);}while(mcp_b(1) > md_mcp_b(1));
            fline(30,30,0.5,100,'n','s',45, "a5", 1);
...
//////////////////////////////////////////////////////////////////////////เริ่มกล่อง 666666666666666666666
        ...
        fw_ch_can(30, 30, 0.3, 500, 10); delay(200);
